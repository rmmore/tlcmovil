        ...
        function link (scope, element, attrs) {
            ...
            function eventHandler(e) {
				...
				if(	(229 == charCode && !value && oldValue && oldValue.length > 1) || // Teclas . y - en android
					(e.type === 'keypress' && (
						37 == charCode || // Tecla % para ipad
						40 == charCode || // Tecla ( para ipad
						41 == charCode || // Tecla ) para ipad
						38 == charCode || // Tecla & para ipad
						64 == charCode	  // Tecla @ para ipad
					))
				) {
					setLastValue();
					return false;
				...
				// Corrige problema en teclado de Samsung cuando no ingresaba algunos numeros al presionar
				scope.$apply();
