...
(function(angular) {    
    ...
    function CardsSwiperController(
        ...
        $rootScope.flagFrequentCardEnable = false;
         
        //Validacion para input de tarjetas en firefox
        ...
        function onChangeCard(_currentIndex, oldIndex) {
             ...
             $rootScope.flagFrequentCardEnable = false;//RPA
        ...
        function selectRemember() {
            ...
            //if(slide.showCardName && slide.cardNameFocus) {RPA
                if(slide.showCardName) {
				//slide.cardNameFocus.focus();RPA
                $rootScope.flagFrequentCardEnable = true;
            }
        }
    }
